...
<script>
    ...
    export default {
        ...
        data: () => ({
            ...
            loaded:false,
            chartData: {
                labels: ["Electricity","Natural Gas","Solid biofuel","Heat Pump","Gas oil and Diesel oil"],
                datasets: []
            ...
            async drawRadarChart(firstId, secondId) {
                if(store.firstTarget!=="" && store.secondTarget!==""){
                    ...
                    const secondResponse = await axios.get(
                        "http://localhost:1337/householdUsageCountryYear/" + secondId +"/2020"
                    );
                    ...
                    var firstData = {
                        label: firstId,
                        data: [parseFloat(JSON.stringify(firstResponse.data[1].value)),
                    ...
                    var secondData = {
                        label: secondId,
                        data: [parseFloat(JSON.stringify(secondResponse.data[0].value)),
