...
app.get('/electricity/one/:geo/:year/:household', async (req, res) => {
	const prices = await db.getElCountryPrice(
...
app.get('/prices/getMaxEl/:geo/:household', async (req, res) => {
	const prices = await db.getMaxElPrice(
		req.params['household'],
		req.params['geo']
	);
	res.status(200).json(prices);
...
app.get('/prices/getMinEl/:geo/:household', async (req, res) => {
	const prices = await db.getMinElPrice(
		req.params['household'],
		req.params['geo']
	);
	res.status(200).json(prices);
...
app.get('/prices/getMaxGas/:geo/:household', async (req, res) => {
	const prices = await db.getMaxGasPrice(
		req.params['household'],
		req.params['geo']
	);
	res.status(200).json(prices);
...
app.get('/electricity/year/:year/:household', async (req, res) => {
	...
	const prices = await db.getElYearPrices(
		req.params['household'],
		req.params['year']
	);
	res.status(200).json(prices);
...
app.get('/electricityCountry/:geo/:household', async (req, res) => {
	const prices = await db.getElAllCountryPrices(
		req.params['household'],
		req.params['geo']
	);
...
app.get('/gasOne/:geo/:year/:household', async (req, res) => {
	const prices = await db.getGasCountryPrice(
		req.params['household'],
		req.params['geo'],
		req.params['year']
	);
...
app.get('/gasYear/:year/:household', async (req, res) => {
	const prices = await db.getGasYearPrices(
		req.params['household'],
		req.params['year']
	);
	res.status(200).json(prices);
...
app.get('/gasCountry/:geo/:household', async (req, res) => {
	...
	const prices = await db.getGasByCountry(
		req.params['household'],
		req.params['geo']
	);
	res.status(200).json(prices);
...
app.get('/householdUsageCountryFuel/:geo/:siec', async (req, res) => {
	const result = await db.getHouseholdUsageCountryFuel(
		req.params['geo'],
		req.params['siec']
	);
	res.status(200).json(result);
...
app.get('/householdUsageYearFuel/:year/:siec', async (req, res) => {
	const result = await db.getHouseholdUsageYearFuel(
		req.params['year'],
		req.params['siec']
	);
	res.status(200).json(result);
...
app.get('/householdUsageCountryYear/:geo/:year', async (req, res) => {
	const result = await db.getHouseholdUsageCountryYear(
		req.params['geo'],
		req.params['year']
	);
	res.status(200).json(result);
...
app.get('/householdSize/:geo/:year', async (req, res) => {
	const result = await db.getHouseholdSize(
		req.params['geo'],
		req.params['year']
	);
	res.status(200).json(result);
...
app.get('/population/:geo/:year', async (req, res) => {
	const result = await db.getPopulation(req.params['geo'], req.params['year']);
	res.status(200).json(result);
});

app.get('/earnings/:geo/:year', async (req, res) => {
	const result = await db.getEarnings(req.params['geo'], req.params['year']);
	res.status(200).json(result);
});
